...
public class Iso7816 {
    ...
    public final static class Tag {
        ...
        public String cmd(String cmd) {
            Response response = new Response(transceive(hexStringToBytes(cmd)));
            LogUtils.i("NFC返回的数据:" + response.toString());
         ...
         * @return
         */
        public Response initForload(String money) {

            Log.i("赵盼龙", "[initForload]");


            return new Response(transceive(hexStringToBytes(money)));
        }

        public Response writeMAC2(String cmd) {
            Log.i("赵盼龙", "[writeMAC2]");
            return new Response(transceive(hexStringToBytes(cmd)));
        }
        ...
        public Response readFile2() {
            Log.i("赵盼龙", "[readFile2]");
            return new Response(transceive(hexStringToBytes("00A40000021001")));
        }
