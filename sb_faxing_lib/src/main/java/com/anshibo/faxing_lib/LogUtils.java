...
public class LogUtils {
    ...
    public static final String ROOT = Environment.getExternalStorageDirectory().getPath() + "/teachers/"; // SD卡中的根目录
    private static final boolean isSaveLog = false; // 是否把保存日志到SD卡中
    private static final String PATH_LOG_INFO = ROOT + "logs/";
    ...
    public static String customTagPrefix = "shibo"; // 自定义Tag的前缀
    // 容许打印日志的类型，默认是true，设置为false则不打印
    private static boolean allowD = BuildConfig.DEBUG;
    private static boolean allowE = BuildConfig.DEBUG;
    private static boolean allowI = BuildConfig.DEBUG;
    private static boolean allowV = BuildConfig.DEBUG;
    private static boolean allowW = BuildConfig.DEBUG;
    private static boolean allowWtf = BuildConfig.DEBUG;
    /**
     * 自定义的logger
     */
